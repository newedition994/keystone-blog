import { CaptionLayout, ClassNames, Components, DayClickEventHandler, DayFocusEventHandler, DayKeyboardEventHandler, Formatters, Labels, ModifiersClassNames, ModifiersMatchers, MonthChangeEventHandler } from './';
import { DayPickerProps } from './DayPickerProps';
/**
 * Represent the value of a DayPicker context.
 */
export interface DayPickerContextValue extends Omit<DayPickerProps, 'className' | 'style' | 'month' | 'fromMonth' | 'toMonth' | 'fromYear' | 'toYear'> {
